...
data = load('gen_laplacian/generated/Input_Laplacian_3x3_1e-7_CSR5.mat.bak')
save '-mat7-binary' 'gen_laplacian/generated/Input_Laplacian_3x3_1e-7_CSR5.mat' data
